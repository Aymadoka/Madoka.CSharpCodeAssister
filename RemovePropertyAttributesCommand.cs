...
namespace Madoka.CSharpCodeAssister
{
    ...
    internal class RemovePropertyAttributesCommand : Command
    {
        private static readonly Guid TextEditorContext = new("5EFC7975-14BC-11CF-9B2B-00AA00573819");

        public override CommandConfiguration CommandConfiguration => new("%RemovePropertyAttributesCommand.DisplayName%")
        {
            TooltipText = "%RemovePropertyAttributesCommand.ToolTipText%",
            Placements = new[]
            {
        ...
        public RemovePropertyAttributesCommand(VisualStudioExtensibility extensibility)
            : base(extensibility)
        {
        }
        ...
        public override async Task ExecuteCommandAsync(IClientContext context, CancellationToken cancellationToken)
        {
            ...
            var convertedText = PropertyAttributeRemover.TryRemove(originalText, caretPosition);
