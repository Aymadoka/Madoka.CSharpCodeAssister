...
namespace Madoka.CSharpCodeAssister
{
    ...
    internal class MakePropertiesPrivateSetCommand : Command
    {
        private static readonly Guid TextEditorContext = new("5EFC7975-14BC-11CF-9B2B-00AA00573819");

        public override CommandConfiguration CommandConfiguration => new("%MakePropertiesPrivateSetCommand.DisplayName%")
        {
            TooltipText = "%MakePropertiesPrivateSetCommand.ToolTipText%",
            Placements = new[]
            {
        ...
        public MakePropertiesPrivateSetCommand(VisualStudioExtensibility extensibility)
            : base(extensibility)
        {
        }
        ...
        public override async Task ExecuteCommandAsync(IClientContext context, CancellationToken cancellationToken)
        {
            ...
            var convertedText = PropertyPrivateSetterConverter.TryConvert(originalText, caretPosition);
