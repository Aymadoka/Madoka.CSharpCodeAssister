...
namespace Madoka.CSharpCodeAssister
{
    ...
    internal class FormatXmlDocCommentsCommand : Command
    {
        // Standard text editor context; shortcut is only active while editing code.
        private static readonly Guid TextEditorContext = new("5EFC7975-14BC-11CF-9B2B-00AA00573819");

        public override CommandConfiguration CommandConfiguration => new("%FormatXmlDocCommentsCommand.DisplayName%")
        {
            TooltipText = "%FormatXmlDocCommentsCommand.ToolTipText%",
            Placements = new[]
            {
        ...
        public FormatXmlDocCommentsCommand(VisualStudioExtensibility extensibility)
            : base(extensibility)
        {
        }
        ...
        public override async Task ExecuteCommandAsync(IClientContext context, CancellationToken cancellationToken)
        {
            ...
            var formattedText = XmlDocCommentFormatter.Format(originalText);
